...
namespace VoTanPhatVCBRDemo.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = VoTanPhatVCBRDemoConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(VoTanPhatVCBRDemoDbContext context)
        {
            _context = context;
        }
