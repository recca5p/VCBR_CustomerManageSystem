...
{
    public abstract class VoTanPhatVCBRDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VoTanPhatVCBRDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VoTanPhatVCBRDemoWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<VoTanPhatVCBRDemoDbContext> action)
        {
            using (var context = IocManager.Resolve<VoTanPhatVCBRDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<VoTanPhatVCBRDemoDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<VoTanPhatVCBRDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VoTanPhatVCBRDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VoTanPhatVCBRDemoDbContext, Task<T>> func)
        {
            T result;
